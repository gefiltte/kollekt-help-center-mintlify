...
sidebarTitle: "Browsing Direct Line"
---
...
**What you'll see:** Top-left: "< Safari" back link and "Klara" artist name. Header: artist avatar, **"Direct Line"** title, share icon, send icon, and chat icon. Three posts from "Klara" (purple name): a welcome text message with a filled red heart. A second post (9h ago) with a **blurred/locked content area** and a lock icon — this is subscriber-only content with an empty heart. A third post (9h ago) with a photo grid showing mountain landscape images ("+ 3 more"), text "Greetings from Swiss Alps 🇨🇭❗" and "Hope you all had a great weekend, too!" with an empty heart. Bottom: **"Open chat"** button with chat icon, and navigation bar with Home, Direct Line (active), Chat.
