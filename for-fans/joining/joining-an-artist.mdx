...
Before joining, you can browse the artist's page, Direct Line, and Chat — but content may be empty or read-only depending on whether the artist has claimed their page.

### Unclaimed Artist — Home

An unclaimed artist page shows the artist's name, photo, and social links but is marked as "Unclaimed" and has a **Claim** button visible.

![Unclaimed artist home page](screenshots/onboarding-home-unclaimed-artist-not-joined.png)

**What you'll see:** A turquoise/teal background with the artist's photo. Top-left: a green **"Claim"** button. Artist name: **"Klara Hammarström"** with **"Unclaimed"** label below. Social icons: X, Facebook, Instagram, YouTube, Spotify. Bottom: gradient **"Slide to Join"** bar. Navigation: Home (active), Direct Line, Chat.

### Claimed Artist — Home

A claimed artist page shows the artist's full profile with content sections.

![Claimed artist home page before joining](screenshots/onboarding-home-claimed-artist-not-joined.png)
...
### Unclaimed Artist — Chat

![Unclaimed artist chat before joining](screenshots/onboarding-chat-unclaimed-artist-not-joined.png)

**What you'll see:** Header: "# Main Chat" with share, send, and members icons. The chat area is completely empty — no messages. Bottom: gradient **"Slide to Join"** bar. Navigation: Home, Direct Line, Chat (active).

### Claimed Artist — Chat

![Claimed artist chat before joining](screenshots/onboarding-chat-claimed-artist-not-joined.png)
...
### Unclaimed Artist — Direct Line

![Unclaimed artist Direct Line before joining](screenshots/onboarding-direct-line-unclaimed-artist-not-joined.png)

**What you'll see:** Header: artist avatar and **"Direct Line"** with share, send, and chat icons. The feed area is completely empty — no posts. Bottom: gradient **"Slide to Join"** bar. Navigation: Home, Direct Line (active), Chat.

### Claimed Artist — Direct Line

![Claimed artist Direct Line before joining](screenshots/onboarding-direct-line-claimed-artist-not-joined.png)
...
![In-app artist search](screenshots/onboarding-app-artist-search.png)

**What you'll see:** A dark overlay with **KOLLEKT K** logo and **X** close button. Profile "kollektor123" with right arrow. Search field with **"Q Klara"** typed and clear (x) button. Results: **"Klara Hammarström"**, **"Klara Kormendi"**, **"Klara Eklund"**, **"Klara"**, **"Klara"** — each with avatars and right arrows. The keyboard is open.

### Web Search

On the Kollekt website, you can also search for artists before downloading the app.

![Web artist search](screenshots/onboarding-web-artist-search.png)

**What you'll see:** A white/cream page with the **KOLLEKT K** logo centered at top. Back arrow (left) and share icon (right). Heading: **"View your Kollekt page"**. Search field with **"Q Klara"** typed and clear (x) button. Results on a dark background: **"Klara Hammarström"**, **"Klara Kormendi"**, **"Klara Eklund"** — each with avatars and right arrows. The keyboard is open.
...
- The "Claim" button visible on unclaimed artist pages is an artist-facing feature, not a fan action — its presence in the fan onboarding screenshots may be confusing.
