...
Every space has two rooms: **Main Chat** for every member, and **Subscribers Chat** only for paying subscribers. Fans talk to each other and to you. Anyone can send a message, tap a heart to react, or reply to someone. Replies show up under the original message.
