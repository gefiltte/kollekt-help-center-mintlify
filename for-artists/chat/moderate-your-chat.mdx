...
**What you'll see:** Four duration pills — **1 hour**, **1 day**, **7 days**, **Permanently** — and a bottom button reading **"Timeout for [duration]"**.

### While a timeout is active

![Active timeout state](screenshots/chat-moderation-timeout-active.png)

**What you'll see:** Status shows **"Muted · [time remaining]"**. The bottom button turns red and reads **"Remove timeout"**.
