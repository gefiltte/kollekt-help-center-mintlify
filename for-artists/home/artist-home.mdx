...
The bottom navigation bar is persistent across the app. From Home, you can reach all other sections.
...
**What you'll see:** Tapping the **speech bubble icon** (third from right in the nav bar) opens Chat. Shows "# Main Chat ∨" header with active messages from fans. The Chat icon is highlighted in the nav bar. For full Chat documentation, see [Run your community chat](/for-artists/chat/community-chat).
