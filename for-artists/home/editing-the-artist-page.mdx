...
After selecting a social platform, enter the profile URL. The app validates the format and shows an error if it's invalid.

![Social URL validation error](screenshots/home-edit-social-validation.png)

**What you'll see:** A text field labeled "Facebook URL" with "www.facebook.com/" entered. Below it in **red**: "Please enter valid Facebook url".
