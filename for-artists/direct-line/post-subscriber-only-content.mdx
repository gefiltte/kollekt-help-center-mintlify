...
Subscriber-only posts are how subscription value sells itself — non-subscribers see the post exists but can't open it, so the perk becomes obvious without you having to pitch it. Lock a Direct Line message to paying subscribers and everyone else gets a locked preview in their feed that tells them they're missing something.
